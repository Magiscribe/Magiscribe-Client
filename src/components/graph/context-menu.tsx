...
export default function ContextMenu({
  ...
  return (
    <motion.div
      ...
      className="fixed bg-white border border-slate-200 rounded-xl p-2 z-10 shadow-xl"
      {...props}
    >
      <div className="text-sm ">
        <p className="text-slate-800 border-b border-slate-200 pb-2 mb-2">Add Node</p>
